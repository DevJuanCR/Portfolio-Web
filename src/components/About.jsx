    ...
    <section id="about" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          {/* avatar */}
          <div className="w-48 h-48 rounded-full bg-slate-800 border-2 border-blue-500/30 flex items-center justify-center shrink-0">
            <span className="text-6xl">👨‍💻</span>
          </div>

          <div className="space-y-4 text-slate-300 text-center md:text-left">
            <p>
              Junior Developer with a double technical degree in
              {' '}<span className="text-blue-400">Application Development (DAM)</span> and
              {' '}<span className="text-blue-400">IT Systems & Networking (SMR)</span>.
            </p>
            <p>
